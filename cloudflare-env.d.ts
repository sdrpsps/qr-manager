/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: 15b4c9a8ef9d61bc1436f8f44d9e4cb5)
...
declare namespace Cloudflare {
	interface Env {
		...
		DB: D1Database;
		WORKER_SELF_REFERENCE: Fetcher /* qr-manager */;
		ASSETS: Fetcher;
	}
}
