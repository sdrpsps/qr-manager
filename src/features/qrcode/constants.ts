...
> = {
  classic: {
    ...
    options: {
      ...
      type: "canvas",
      data: "",
      dotsOptions: { color: "#222", type: "square", gradient: undefined },
  ...
  elegant: {
    ...
    options: {
      ...
      type: "canvas",
      data: "",
      dotsOptions: { color: "#7C3AED", type: "classy", gradient: undefined },
  ...
  modernBlue: {
    ...
    options: {
      ...
      type: "canvas",
      data: "",
      dotsOptions: { color: "#2563EB", type: "rounded", gradient: undefined },
  ...
  business: {
    ...
    options: {
      ...
      type: "canvas",
      data: "",
      dotsOptions: { color: "#1E3A8A", type: "square", gradient: undefined },
